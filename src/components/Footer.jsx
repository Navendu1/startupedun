export default function Footer() {
  return (
    <footer className="w-full border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-8 px-8 py-12 mx-auto">
        {/* About Section */}
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">StartupEdu</h3>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><a href="/learning-modules" className="hover:text-primary">Learning Modules</a></li>
            <li><a href="/interactive-tools" className="hover:text-primary">Interactive Tools</a></li>
